---
title: 'Optimize Smart Contracts Solidity'
...
Libraries are sometimes only imported for a small number of uses, which means that they may contain a significant amount of code that is redundant to your contract.
